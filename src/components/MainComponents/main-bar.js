...
const Mainbar = (props) => {
  ...
  const handleClick = (e) => {
    e.preventDefault()
    dispatch(setData(inputData.stateName,inputData.guests,inputData.startDate,inputData.endDate));
  ...
  return (
    <div className="master">
      <div className="location-main">
        location
        <input onChange={handleChange} type="text" placeholder="State" id="stateName" value={inputData.stateName}></input>
      </div>
      <div className="guests-main">
        Guests
        <input onChange={handleChange} type="number" placeholder="Guests" id="guests" value={inputData.guests}></input>
      </div>
